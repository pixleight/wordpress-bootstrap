							...
							<div class="col-xs-8 col-xs-push-4 col-sm-9 col-sm-push-3 clearfix">
								...
								<header>
									...
									<?php if( get_post_type() == 'post' ) : ?>
										<p class="meta"><?php _e("Posted", "wpbootstrap"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_time(); ?></time> <span class="amp">&</span> <?php _e("filed under", "wpbootstrap"); ?> <?php the_category(', '); ?>.</p>
									<?php endif; ?>
